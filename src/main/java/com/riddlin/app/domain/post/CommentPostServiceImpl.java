...
public class CommentPostServiceImpl extends AbstractPostServiceImpl implements CommentPostService {
     ...
     * (non-Javadoc)
     * 
     * @see com.riddlin.app.domain.post.CommentPostService#getCommentById(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddlin.app.domain.post.CommentPostService#getPublishedComments(int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddlin.app.domain.post.CommentPostService#getAllCommentsForPost(java.lang.String) 
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddlin.app.domain.post.CommentPostService#getPublishedCommentsForUser(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddlin.app.domain.post.CommentPostService#getAllComments(org.springframework.data.domain.Pageable)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddlin.app.domain.post.CommentPostService#addComment(java.lang.String, java.lang.String)
     */
    @Override
    @PreAuthorize("hasRole('ROLE_USER')")
     ...
     * (non-Javadoc)
     * 
     * @see com.riddlin.app.domain.post.CommentPostService#updateComment(java.lang.String, java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddlin.app.domain.post.CommentPostService#setCommentPublished(java.lang.String, boolean)
     */
    @Override
    @PreAuthorize("hasRole('ROLE_ADMIN') or hasRole('ROLE_USER')")
     ...
     * (non-Javadoc)
     * 
     * @see com.riddlin.app.domain.post.CommentPostService#setCommentSpam(java.lang.String, boolean)
     */
    @Override
    @PreAuthorize("hasRole('ROLE_ADMIN') or hasRole('ROLE_USER')")
     ...
     * (non-Javadoc)
     * 
     * @see com.riddlin.app.domain.post.CommentPostService#deleteComment(java.lang.String)
     */
    @Override
    @PreAuthorize("hasRole('ROLE_ADMIN')")
