...
public class UserAdminServiceImpl implements UserAdminService {
     ...
     * 
     * @see
     * com.riddlin.app.domain.account.UserAdminService#createUserAccount(org.springframework.social.connect.ConnectionData
     * )
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddlin.app.domain.account.UserAdminService#setAuthor(java.lang.String, boolean)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddlin.app.domain.account.UserAdminService#getCurrentUser()
     */
    @Override
