...
public class BlogPostServiceImpl extends AbstractPostServiceImpl implements BlogPostService {
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.post.BlogService#getAllPublishedPosts(org.springframework.data.domain.Pageable)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.post.BlogPostService#getPublishedPosts(int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.post.BlogPostService#getPublishedPostsByTag(java.lang.String, org.springframework.data.domain.Pageable)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.post.BlogPostService#getTagCloud()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.post.BlogPostService#getPostByPublishedPath(int, int, java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * 
	 * @see com.riddler.app.domain.post.BlogPostService#getPublishedPostById(java.lang.String)
	 */
	@Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.post.BlogService#getPostById(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.post.BlogPostService#getPostsForCurrentUser()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.post.BlogService#createPost(java.lang.String, java.lang.String)
     */
    @Override
    @PreAuthorize("hasRole('ROLE_AUTHOR')")
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.post.BlogPostService#updateContent(java.lang.String, java.lang.String)
     */
    @Override
    @PreAuthorize("hasRole('ROLE_AUTHOR')")
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.post.BlogPostService#updateMeta(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
     */
    @Override
    @PreAuthorize("hasRole('ROLE_AUTHOR')")
