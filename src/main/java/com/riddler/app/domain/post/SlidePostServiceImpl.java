...
public class SlidePostServiceImpl extends AbstractPostServiceImpl implements SlidePostService{
    ...
    /*
     * (non-Javadoc)
     * @see com.riddler.app.domain.post.SlidePostService#getSlideByPublishedPath(java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.riddler.app.domain.post.SlidePostService#getSlidePostsForCurrentUser(org.springframework.data.domain.Pageable)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.riddler.app.domain.post.SlidePostService#getSlideById(java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.riddler.app.domain.post.SlidePostService#createSlide(com.riddler.app.domain.post.StyleType, java.lang.String, java.lang.String, java.lang.String)
     */
    @Override
    @PreAuthorize("hasRole('ROLE_AUTHOR')")
    ...
    /*
     * (non-Javadoc)
     * @see com.riddler.app.domain.post.SlidePostService#updateSlide(com.riddler.app.domain.post.SlidePost)
     */
    @Override
