...
public class CounterServiceImpl implements CounterService {
    ...
    /* (non-Javadoc)
     * @see com.riddler.app.domain.counter.CounterService#getNextUserIdSequence()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.riddler.app.domain.counter.CounterService#logVisit()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.riddler.app.domain.counter.CounterService#getVisitCount()
     */
    @Override
