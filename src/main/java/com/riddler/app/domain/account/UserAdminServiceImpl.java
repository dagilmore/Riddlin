...
public class UserAdminServiceImpl implements UserAdminService {
     ...
     * 
     * @see
     * com.riddler.app.domain.account.UserAdminService#createUserAccount(org.springframework.social.connect.ConnectionData
     * )
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.account.UserAdminService#setAuthor(java.lang.String, boolean)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.account.UserAdminService#getCurrentUser()
     */
    @Override
