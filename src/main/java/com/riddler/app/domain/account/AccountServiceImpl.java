...
public class AccountServiceImpl implements AccountService {
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.account.AccountService#findByUsername(java.lang .String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.riddler.app.domain.account.AccountService#getAllUsers()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.application.AccountService#getAllUsers(org.springframework.data.domain.Pageable)
     */
    @Override
    @PreAuthorize("hasRole('ROLE_ADMIN')")
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.account.AccountService#getConnectionsByUserId(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.account.AccountService#updateProfile(java.lang.String, java.lang.String,
     * java.lang.String)
     */
    @Override
    @PreAuthorize("hasRole('ROLE_ADMIN')")
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.account.AccountService#updateImageUrl(java.lang.String, java.lang.String)
     */
    @Override
    @PreAuthorize("hasRole('ROLE_USER')")
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.application.AccountService#createUserAccount(org.springframework.social.connect.ConnectionData)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.account.AccountService#lockAccount(java.lang.String, boolean)
     */
    @Override
    @PreAuthorize("hasRole('ROLE_ADMIN')")
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.account.AccountService#trustAccount(java.lang.String, boolean)
     */
    @Override
    @PreAuthorize("hasRole('ROLE_ADMIN')")
     ...
     * (non-Javadoc)
     * 
     * @see com.riddler.app.domain.account.AccountService#setAuthor(java.lang.String, boolean)
     */
    @Override
    @PreAuthorize("hasRole('ROLE_ADMIN')")
